          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="space-y-12">
                ...
                <div className="card p-8">
                  <h2 className="text-2xl font-medium mb-6">Research Publications</h2>
                  <div className="space-y-8">
                    <PublicationCard
                      title="Tokenization Challenges in Multilingual GPT"
                      conference="ICIIRS-23"
                      description="Research addressing real-world challenges in multilingual AI text generation, focusing on optimizing tokenization for non-English languages."
                    ...
                    <PublicationCard
                      ...
                      conference="ICIIRS-23"
                      description="Published findings demonstrating practical applications of ML in financial fraud detection, with a focus on ensemble methods and imbalanced datasets."
                    ...
                    <PublicationCard
                      ...
                      description="Research on deep learning-based image augmentation techniques, achieving 98.57% accuracy on MNIST and advancing robust computer vision techniques."
...
function PublicationCard({ title, conference, description, image, link }) {
  return (
    <div className="flex flex-col md:flex-row gap-6 border-b border-gray-800 pb-8 last:border-0 last:pb-0">
      <div className="md:w-1/3">
        <img src={image || "/placeholder.svg?height=200&width=300"} alt={title} className="w-full h-auto rounded-md" />
      </div>
      <div className="md:w-2/3">
        <Link href={link} target="_blank" className="hover:text-purple-400 transition-colors">
          <h3 className="text-xl font-medium text-white mb-2">{title}</h3>
        </Link>
        <p className="text-purple-400 mb-3 text-sm">{conference}</p>
