          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              <TimelineItem
                ...
                description="Lead AI Application Developer for LifeConnectApp, an autonomous AI agent system that monitors and automates social media interactions across multiple platforms. Building enterprise integrations using Workday Extend and developing secure authentication systems."
                achievements={[
